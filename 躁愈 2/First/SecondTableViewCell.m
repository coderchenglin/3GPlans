...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    [self.homeModel setSecondTableViewCellArray];
    [self.homeModel setSecondTableViewCellJpgArray];
//    [self.homeModel setSecondTableViewCellVideoArray];
    ...
    [self.customCollectionView registerClass:[SecondCollectionViewCell class] forCellWithReuseIdentifier:@"collectionCell2"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
        SecondCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"collectionCell2" forIndexPath:indexPath];
        cell.bigImageView.image = [UIImage imageNamed:self.homeModel.secondTableViewCellJpgArray[indexPath.item]];
        cell.titleLabel.text = self.homeModel.secondTableViewCellArray[indexPath.item];
        return cell;
}
...
//    NSString *t = self.homeModel.secondTableViewCellVideoArray[indexPath.item];
