...
//- (void)updateLabel {
//
//    NSString *string1 = @"晋商文化：在中国明清以来的近代经济发展史上，驰骋欧亚的晋商举世瞩目，山西特别是以太谷、祁县、榆次、平遥等为代表的太原盆地商人前辈，举商贸之大业，经营范围包罗万象，夺金融之先声，钱庄票号汇通天下，称雄五百余年，创造了亘古未有的世纪性繁荣，在神州大地上留下了灿烂的商业文化。";
//    if (self.currentIndex < string1.length) {
//        NSString *subText = [string1 substringToIndex:self.currentIndex + 1];
